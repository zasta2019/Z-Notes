      ...
      <View style={styles.contentbox}>
        ...
        <KeyboardAvoidingView enabled={true} behavoiur={"padding"}>
          <View style={styles.datacontent}>
            <TextInput style={styles.textAreatitle} multiline={true} numberOfLines={2} placeholder="Type Your Title here..." />
            <TextInput style={styles.textAreadescription} multiline={true} numberOfLines={9} placeholder="Type Your Description here..." />
