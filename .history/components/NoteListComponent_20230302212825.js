...
<SafeAreaView style={{flex: 1}}>
        ...
        <FlatList
        data={notes}
        keyExtractor={note => notes.item.id}
        renderItem={(note) => {
          return (
             <NoteItemComponent
        ...
        //                     <View>
        //                         <Text style={styles.notesheading}>{note.item.title}</Text>
        //                         <Text style={styles.contenttext}>{note.item.desc}</Text>
        //                     </View>
        //                     <View>
        ...
        //                         <Text style={styles.date}>{note.item.time}</Text>
        //                     </View>
        //                 </View>
        //             </View>
        //         </Pressable>
